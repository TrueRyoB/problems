...
You are given an unsorted array $A$ of size $N$. It is guaranteed that every element in $A$ is an integer in the range $[0, N-1]$. You have access to a generative function that returns an index $i \in [0, N-1]$ sampled uniformly at random.
